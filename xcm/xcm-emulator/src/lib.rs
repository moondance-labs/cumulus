...
pub trait RelayChain: Chain {
	...
	type SovereignAccountOf: Convert<MultiLocation, RuntimeAccountId<Self::Runtime>>;
	...
	fn sovereign_account_id_of(location: MultiLocation) -> RuntimeAccountId<Self::Runtime> {
		Self::SovereignAccountOf::convert(location).unwrap()
	}
...
pub trait Parachain: Chain {
	...
	type LocationToAccountId: Convert<MultiLocation, RuntimeAccountId<Self::Runtime>>;
	...
	fn sovereign_account_id_of(location: MultiLocation) -> RuntimeAccountId<Self::Runtime> {
		Self::LocationToAccountId::convert(location).unwrap()
	}
